...
#result path
file_name = project_dir + '/result/Baseline/spmm/rode_sputnik_cusparse_spmm_f32_n128.csv'
...
for index, row in df.iterrows():
    ...
    shell_command = project_dir + "/Baseline/RoDe/build/eval/eval_spmm_f32_n128 " + data_dir + row['dataSet'] + '/' + row['dataSet'] + ".mtx >> " + file_name
    print(row['dataSet'])
